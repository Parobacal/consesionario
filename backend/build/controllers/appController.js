...
class AppController {
    ...
    async createClient(req, res) {
        var query = "INSERT INTO Cliente (Nombre, Direccion, DPI, Edad, Genero) VALUES (?, ?, ?, ?, ?)";
        var body = req.body;
        console.log(body);
        try {
            db_1.default.getConnection(function (err, conn) {
                conn.query(query, [body.nombre, body.correo, body.direccion, body.dpi, body.edad, body.genero], function (err2, results, field) {
                    console.log(results);
                });
...
exports.appCtrl = new AppController();
